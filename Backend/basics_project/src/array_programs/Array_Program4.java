...
public class Array_Program4 {
	...
	//Wrapper class	 Byte Short Integer Long Double Float Boolean
		...
		Integer [] arr3= {35,23,56,78,54,0,12};
		Arrays.sort(arr3,Collections.reverseOrder());//sort elements in descending order
		...
		//            0 1 2 3 4 5 
		int []arr6= {12,25,38,49,70};
        //              existing arrray  starting array   ending array
...
//		
		int arr9[]= {23,45,66,89,34,55};
		Arrays.sort(arr9);
		System.out.println(Arrays.toString(arr9));
		int searchIndex=Arrays.binarySearch(arr9, 55);
